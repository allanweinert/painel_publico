...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a>
              <span class="hidden-xs"><?php echo $viewData['user']->getName(); ?></span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="<?php echo BASE_URL; ?>login/logout" class=" btn-primary"><img src="<?php echo BASE_URL; ?>assets/images/out.png" class="img-circle" height="15px" width="15px" alt="Out Image"></a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo ($viewData['menuActive']=='home')?'active':''; ?>"><a href="<?php echo BASE_URL; ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        ...
        <li class="<?php echo ($viewData['menuActive']=='categories')?'active':''; ?>"><a href="<?php echo BASE_URL; ?>categories"><i class="fa fa-folder"></i> <span>Categorias</span></a></li>
       <?php endif; ?>
        ...
        <?php if($viewData['user']->hasPermission('purchases_view')): ?>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Íris Sistemas</a>.</strong> Todos os direitos reservados.
  </footer>
